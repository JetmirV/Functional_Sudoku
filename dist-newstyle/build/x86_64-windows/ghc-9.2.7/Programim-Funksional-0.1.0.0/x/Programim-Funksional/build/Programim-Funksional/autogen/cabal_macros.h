...
/* package Programim-Funksional-0.1.0.0 */
#ifndef VERSION_Programim_Funksional
#define VERSION_Programim_Funksional "0.1.0.0"
#endif /* VERSION_Programim_Funksional */
#ifndef MIN_VERSION_Programim_Funksional
#define MIN_VERSION_Programim_Funksional(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Programim_Funksional */
...
#define CURRENT_COMPONENT_ID "Programim-Funksional-0.1.0.0-inplace-Programim-Funksional"
